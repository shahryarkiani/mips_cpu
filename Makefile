...
EXE_NAME=processor
SRCS := main.cpp memory.cpp processor.cpp superscalar_processor.cpp outoforder_processor.cpp
OBJS := $(SRCS:.cpp=.o)
...
processor.o: regfile.h ALU.h control.h processor.h pipeline.h superscalar_processor.o outoforder_processor.o
memory.o: memory.h
